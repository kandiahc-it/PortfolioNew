...
const CursorGrid = ({
  ...
  useEffect(() => {
    ...
    const activeEl = container.parentElement || container;
    activeEl.addEventListener('pointermove', onPointerMove);
    activeEl.addEventListener('pointerdown', onPointerDown);

    return () => {
      cancelAnimationFrame(raf);
      ro.disconnect();
      activeEl.removeEventListener('pointermove', onPointerMove);
      activeEl.removeEventListener('pointerdown', onPointerDown);
    };
  }, [cellSize]);
