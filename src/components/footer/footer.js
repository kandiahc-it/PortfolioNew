...
const Footer = () => {
  return (
    <footer className='footer'>
        <span>Copyright &#169; 2024 Kandiah. All rights received.</span>
        <a href="https://github.com/kandiahc-it/Portfolio-in-React" target="_blank" rel="noopener noreferrer" className="footerGithubStar">
          
          <svg className="footerStarIcon" viewBox="0 0 16 16" width="12" height="12" style={{ fill: 'currentColor' }}>
          ...
          <svg className="githubFooterIcon" viewBox="0 0 16 16" width="14" height="14" style={{ fill: 'currentColor' }}>
