...
import { SiHtml5, SiCss3, SiTailwindcss, SiJavascript, SiNodedotjs, SiExpress, SiJsonwebtokens, SiFlutter, SiDart, SiFigma, SiGooglecolab, SiN8N, SiTensorflow, SiLangchain, SiMongodb, SiMysql, SiCplusplus, SiGithub, SiGoogle } from "react-icons/si";
import { TbBrandReactNative, TbCube } from "react-icons/tb";
import { IoExtensionPuzzle } from "react-icons/io5"; // For Zustand/Bloc/RAG fallback if needed
  ...
  SkillsInTechnologies: [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Zustand", icon: <IoExtensionPuzzle /> }, // Using Puzzle as generic for state/library
      ],
    },
    {
      ...
      skills: [
        ...
        { name: "Bloc", icon: <TbCube /> }, // Cube for Bloc
      ],
    },
    {
      title: "Design & Cloud Tools",
      skills: [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Gemini API", icon: <SiGoogle /> }, // Using Google icon for Gemini
        { name: "RAG", icon: <IoExtensionPuzzle /> }, // Generic icon for Architecture
      ],
    },
    {
      title: "Databases",
